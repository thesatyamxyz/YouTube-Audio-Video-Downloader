...
<meta name="description" content="YouTube Video Downloader Online."/>
...
<h1 class="hero-header">YouTube Video Downloader</h1>
<div class="ads_banner m-t m-b">
</div>
<div>
	<form class="form-inline form-search" action="/#converted" id="search-form" method="GET">
		...
		<button type="submit" id="btn-submit" class="btn btn-lg" style="margin-top:15px;">
			<span class="fa fa-video-camera"></span> <span class="hidden-xs">START</span>
		</button>
		<br>
...
<?php if(empty($ytid)){}else{?>
	<div class="loading"><iframe src="https://yts1.cyou/video/<?php echo $yurl;?>" style="width:100%;height:500px;border:none;"></iframe></div>
<?php } ?>
</div>
</div>
</div>
